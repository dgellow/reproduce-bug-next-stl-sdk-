...
function setShims(shims, options = { auto: false }) {
    if (exports.auto) {
        throw new Error(`you must \`import 'nuntly/shims/${shims.kind}'\` before importing anything else from nuntly`);
    }
    if (exports.kind) {
        throw new Error(`can't \`import 'nuntly/shims/${shims.kind}'\` after \`import 'nuntly/shims/${exports.kind}'\``);
    }
